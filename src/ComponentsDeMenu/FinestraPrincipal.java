...
public class FinestraPrincipal extends JFrame implements ActionListener
	{
		...
		public FinestraPrincipal()//constructor
		{
			...
			setTitle("IES Benigasl� - Components de Men�");
		...
		private void iniciarComponentes() {
	        ...
	        itemEmergente1.setText("Opci� Emergent 1");
	        menuEmergente.add(itemEmergente1);
	        itemEmergente2.setText("Opci� Emergent 2");
	        menuEmergente.add(itemEmergente2);
	        ///
	        	        
	        /*Crea los items del menu Acerca De...*/
	        menuItemAplicacion.setText("Aplicaci�");
		...
		public void actionPerformed(ActionEvent evento) {
			...
			if (evento.getSource()==itemEmergente1) {
				JOptionPane.showMessageDialog(null, "Has seleccionat l'opci�n emergent 1");
			}
			
			if (evento.getSource()==itemEmergente2) {
				JOptionPane.showMessageDialog(null, "Has seleccionat l'opci�n emergent 2");
			}
